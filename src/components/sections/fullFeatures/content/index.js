const content = {
  features: [
    ...
    },
    {
      ...
      description: 'Security is our TOP priority. We\'ve implemented more than 300 security measures, security risk control measures and strategies to provide the same level of security as national banks.'
    },
    {
    ...
    },
    {
      ...
      description: '24/7 expert support to guarantee a smooth user experience and quick feedback and resolution of any support inquiry.'
    },
    {
      image: require('src/images/section-full-features/otc-trading.svg'),
      title: 'OTC Trading',
      description: 'A trusted platform with intuitive user interface allowing professionals to trade tokens with fiat currency conveniently.'
    },
    {
      image: require('src/images/section-full-features/margin-trading.svg'),
      title: 'Spot / Margin Trading',
      description: 'Trade over a hundred types of tokens including Bitcoin, Ethereum & Litecoin with leverage options.'
    },
    {
      image: require('src/images/section-full-features/futures-trading.svg'),
      title: 'Futures Trading',
      description: 'Stabilize income earned through futures trading, arbitrage and hedge your risks conveniently'
    },
    {
    ...
    },
    {
      ...
      description: 'Powerful product features and sophisticated trading tools to satisfy any professional trader, but the platform has also been designed to be user-friendly for any crypto rookies.'
    },
    {
      image: require('src/images/section-full-features/mobile.svg'),
      title: 'Mobile app',
      description: 'Mobile app with the whole range of tools that you have with the web version. Trade on the go from anywhere in the world.',
