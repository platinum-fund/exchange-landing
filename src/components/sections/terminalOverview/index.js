    ...
    <div className="wrapper_section-content">
      <header className="headline">
        <h2 className="title title_theme_section">
          BTCNEXT Exchange Trading Terminal Has Two Modes
        </h2>
        <h3 className="subtitle">
          <span className="subtitle_theme_attention">Basic:</span>
          for quick and easy trading
        </h3>
        <h3 className="subtitle">
          <span className="subtitle_theme_attention">Advanced:</span>
      ...
      <div className="gallery">
        <img
          ...
          src={require('src/images/section-terminal/screens.png')}
        />
      </div>
    </div>
  </section>
